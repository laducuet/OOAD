...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> E-Auction<br>TLS Plaza, 3rd Floor, Blue Area, Islamabad<br>Pakistan</p>
                                                <p>Call us: <span>+84-123456789 </span></p>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Online Auction</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
