			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="customer-login-register">
					...
					<div class="login-Register-info">
						<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" id="register-form" onsubmit="return validatecustomer();">
							...
							<p class="coupon-input form-row-first">
								...
								<input type="text" name="mobile_no" id="mobile_no" value="+92" onkeypress="return isNumber(event)">
							</p>
