...
<div class="container">
	...
	while ($rscategory = mysqli_fetch_array($qsqlcategory)) {
		...
		if (mysqli_num_rows($qsqlproduct) >= 1) {
			?>
			<h2 class="border" style="padding: 10px;"><a href='allproducts.php?category_id=<?php echo $rscategory[0]; ?>'>
				...
				while ($rsproduct = mysqli_fetch_array($qsqlproduct)) {
					...
					<div class="col-md-4">
						<figure class="card card-product">
							<div class="img-wrap">
								<center>
									<a href="single.php?productid=<?php echo $rsproduct[0]; ?>"><img src="<?php echo $imgname; ?>"
											alt=" " class="img-responsive" style="height: 250px;" /></a>
								</center>
							</div>
							<figcaption class="info-wrap">
								<h4 class="title"><a href="single.php?productid=<?php echo $rsproduct[0]; ?>">
										<?php echo $rsproduct['product_name']; ?>
									</a></h4>
								<!-- Timer code starts here -->
								<p id="countdowntime<?php echo $rsproduct[0]; ?>"></p>
								<script
									type="application/javascript">countdowntimer('<?php echo $rsproduct[0]; ?>', '<?php echo date("M d, Y H:i:s", strtotime($rsproduct['end_date_time'])); ?>');</script>
								<!-- Timer code ends here -->
								<div class="rating-wrap">
									<div class="label-rating"><span>Started on
							...
							<div class="bottom-wrap">
								...
								<div class="price-wrap h5">
									<span class="price-new">Current Bid : PKR
										<?php
